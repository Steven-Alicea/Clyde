 ...
 * Modified by Steven M Alicea in 2019
 *
...
package com.example.clyde.Utils;
...
import com.example.clyde.Activities.MapsActivity;
...
public abstract class PermissionUtils {
     ...
     */
    public static void requestPermission(LoginActivity activity, int requestId, String permission, boolean finishActivity) {
    ...
    public static class PermissionDeniedDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(getActivity())
                    .setMessage(R.string.location_permission_denied)                // WHERE IS THIS DIALOG CREATED
